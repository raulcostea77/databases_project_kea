        ...
        <div class="large-10 large-push-1 columns">
            ...
            <div class="artistsList">
            	...
            	@foreach ($catalogues as $catalogue)
					<a href="/catalogues/{{$catalogue->id}}"><li>{{$catalogue->name}}</li></a>
            	@endforeach
            	</ul>
            	<div class="row">
        <div class="large-10 large-push-1 columns">
            <a href="{{$catalogues->previousPageUrl()}}" style="float:left">Previous Page</a>
            <a href="{{$catalogues->nextPageUrl()}}" style="float:right">Next Page</a>
            </div>
        </div>
